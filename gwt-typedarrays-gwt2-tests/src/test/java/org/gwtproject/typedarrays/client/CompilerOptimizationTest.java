...
public class CompilerOptimizationTest {
    ...
    private String getDeployedFile(String s) throws IOException {
        ...
        String path = CompilerOptimizationTest.class.getProtectionDomain().getCodeSource().getLocation().getPath();
        path = path.split("test-classes")[0] + "gwt-tests/www/org.gwtproject.typedarrays.TypedArraysTest.JUnit";
