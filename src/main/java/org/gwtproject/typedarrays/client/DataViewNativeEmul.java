...
public class DataViewNativeEmul implements DataView {
   ...
   */
  private static boolean isNativeLittleEndian() {
    Int8ArrayNative i8 = new Int8ArrayNative(4);
    i8.set(0, 1);
    i8.set(1, 2);
    i8.set(2, 3);
    i8.set(3, 4);
    Int32ArrayNative i32 = new Int32ArrayNative(i8.buffer());
    // TODO(jat): do we need to check for other endianness beside BE/LE?
    return i32.get(0) == 0x04030201;
  };
