...
/**
 * A view representing an {@link ArrayBuffer} as 16-bit unsigned integers. Storing out-of-range
 * values are mapped to valid values by taking the bottom 16 bits of the value.
 *
 * @see <a
...
public interface Uint16Array extends ArrayBufferView {
  ...
  @JsOverlay int BYTES_PER_ELEMENT = 2;
